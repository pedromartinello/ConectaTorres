...
export async function criarDisponibilidade(req, res) {
  ...
  if (conflito) {
    return res.status(409).json({ mensagem: 'Ja existe uma disponibilidade sobreposta.' });
  }
