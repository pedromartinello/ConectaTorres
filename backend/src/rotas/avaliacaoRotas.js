...
import { listarAvaliacoesPrestador, listarMinhasAvaliacoes, criarAvaliacao } from '../controladores/avaliacaoControlador.js';
...
router.get('/minhas', exigirAutenticacao, permitirTipos('cliente', 'prestador'), asyncHandler(listarMinhasAvaliacoes));
